...
class ChatListControllerImplementation extends ChatListController {
  ...
  void _init() async {
    ...
    try {
      final List<ChatRoomModel> response =
          await _chatListService.loadMyChatRooms();
  ...
  void navigateToChat({required String chatRoomId}) async {
    ...
    _router.pushNamed(
      chatRoute.name,
      queryParameters: <String, String>{"itemId": itemId, "ownerId": ownerId},
      pathParameters: <String, String>{"userId": otherUserId},
    );
  }
}
